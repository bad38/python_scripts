...
Hal9000 = map(float, Data_from_Data_base)
Hal9001 = map(float, Data_from_Decay_file)
...
plt.title('Te Acquisition to Crystal St Vs. Rate [Gridsize = 40]')
plt.xlabel('Te_acq_to_Xtal_storage [Days]')
