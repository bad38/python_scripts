				...
				for _id in db.sandbox.find({"_id": ObjectId(value_of_intrest_1)}): 
					...
					for age_1 in db.sandbox.find({"_id": ObjectId(crystal_age_1)}):
						...
						if Te_batch_1 != "NAN":
							...
							Jimmy_Mack.append(str(Channel_1))
							a = {} 
							b = {}
								...
								for line in f: 
									...
									for key, val_1 in a.iteritems(): 
										if key == Channel_1: 
											...
											Pancake_King.append(str(Channel_1) + ' ' + str(val_1) + ' ' + (Te_batch_1))
					...
					for age_2 in db.sandbox.find({"_id": ObjectId(crystal_age_2)}):
						...
						if Te_batch_2 != "NAN":
							...
							#Backstreet.append(Xtal_2)
											...
											BeachBoyz.append(str(Te_batch_2))
											Pancake_King.append(str(Channel_2) + ' ' + str(val_1) + ' ' + (Te_batch_2))
								...
								for line in f: 
									...
									for key, val_1 in a.iteritems(): 
										if key == Channel_4: 
											...
											BeachBoyz.append(str(Te_batch_4)) 
											Pancake_King.append(str(Channel_4) + ' ' + str(val_1) + ' ' + (Te_batch_4))
						#	Backstreet.append(Xtal_4)						
						#	FullObject.append(Te_batch_4)
					

#print(Backstreet) 
print (set(Pancake_King))
print (len(set(Pancake_King)))


Hal9000 = map(int, BeachBoyz)
Hal9001 = map(float, C_d)

#print (len(list(set(Backstreet)))) 
Waffle = list(set(Pancake_King))
thefile = open('Pancake.txt', 'w') 
json.dump(Pancake_King,thefile) 
f.close()
#np.savetxt("Pancake.csv", Waffle, delimiter=",")
#print (len(set(Waffle)))
#print (Waffle)